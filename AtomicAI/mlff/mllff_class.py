...
class mlff:  # traj_file name

    def __init__(self, descriptor_type = None, MLFF = None, **kwargs):
        """
        Parameters:

        descriptor_type: ACSF, SOAP, and so on. Default is SOAP
            A string values.
        ...
        if descriptor_type:
            ...
            self.descriptor_type = 'SOAP'
        if MLFF:
            self.MLFF = MLFF
        else:
            print("There is no initial data of MLFF from select_data_from_trajectory")
